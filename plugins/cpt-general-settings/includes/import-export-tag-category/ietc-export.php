<div class="wrap">
     <h1 class="wp-heading-inline"><?php _e('Export tag & category', GENERAL_SETTINGS_CPT_TEXT_DOMAIN)?></h1>
            ...
            <div id="post-body" class="metabox-holder columns-2">
                  <div id="postbox-container-2" class="postbox-container">
                        ...
                        <table class="form-table" >
                           ...
                           <tr>
                              <td>
                                    <label for="type"><?php _e( 'Type', GENERAL_SETTINGS_CPT_TEXT_DOMAIN ); ?></label>
                              </td>
                              <td>
