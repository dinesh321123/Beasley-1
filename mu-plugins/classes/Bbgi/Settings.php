...
class Settings extends \Bbgi\Module {
	...
	public function register_settings() {
		...
		add_settings_field( 'ee_theme_music_control_color', 'Music Control Color', 'bbgi_input_field', $this->_settings_page_hook, 'ee_site_colors', 'name=ee_theme_music_control_color&default=#ffe964' );
