...
<div
	...
	<div class="gigya-screen" id="gigya-login-screen" data-responsive="true">
		...
		<form class="gigya-login-form" id="gigya-login-form" data-on-success-screen="gigya-login-success-screen">
			...
			<label for="login-loginID">Email</label>
			<input type="text" id="login-loginID" name="loginID" placeholder="Email" />
	...
	<div class="gigya-screen" id="gigya-forgot-password-screen" data-responsive="true">
		...
		<form class="gigya-reset-password-form" id="gigya-reset-password-form" data-on-success-screen="gigya-forgot-password-sent-screen">
			...
			<span class="gigya-error-msg" data-bound-to="loginID" ></span>
			<label for="reset-loginID">Email</label>
			<input type="text" name="loginID" id="reset-loginID" placeholder="Email" />
	...
	<div class="gigya-screen" id="gigya-register-screen" data-responsive="true">
		...
		<form class="gigya-register-form" id="gigya-register-form">
			...
			<input type="text" id="register-firstName" name="profile.firstName" placeholder="First Name" />

			<span class="gigya-error-msg" data-bound-to="profile.lastName" ></span>
			<label for="register-lastName">Last Name</label>
			<input type="text" id="register-lastName" name="profile.lastName" placeholder="Last Name" />

			<span class="gigya-error-msg" data-bound-to="password" ></span>
			<label for="register-password">Password</label>
			<input type="password" id="regsiter-password" name="password" placeholder="Password" />

			<span class="gigya-error-msg" data-bound-to="passwordRetype" ></span>
			<label for="register-passwordRetype">Re-Enter Password</label>
			<input type="password" id="register-passwordRetype" name="passwordRetype" placeholder="Re-Enter Password" />
	...
	<div class="gigya-screen" id="gigya-register-complete-screen" data-responsive="true">
		...
		<form class="gigya-profile-form" id="gigya-profile-form" data-on-success-screen="gigya-register-success-screen">
			...
			<label for="profile-complete-email">Email</label>
			<input type="text" id="profile-complete-email" name="profile.email" placeholder="Email" />

			<span class="gigya-error-msg" data-bound-to="profile.firstName" ></span>
			<label for="profile-complete-firstName">First Name</label>
			<input type="text" id="profile-complete-firstName" name="profile.firstName" placeholder="First Name"/>

			<span class="gigya-error-msg" data-bound-to="profile.lastName" ></span>
			<label for="profile-complete-lastName">Last Name</label>
			<input type="text" id="profile-complete-lastName" name="profile.lastName" placeholder="Last Name" />

			<span class="gigya-error-msg" data-bound-to="profile.birthYear" ></span>
			<label for="profile-complete-birthYear">Year of Birth:</label>
			<select id="profile-complete-birthYear" name="profile.birthYear">
			...
			<label for="profile-complete-birthMonth">Month of Birth:</label>
			<select id="profile-complete-birthMonth" name="profile.birthMonth">
			...
			<label for="profile-complete-birthDay">Day of Birth:</label>
			<select id="profile-complete-birthDay" name="profile.birthDay">
			...
			<label for="profile-complete-zip">ZIP Code</label>
			<input type="text" id="profile-complete-zip" name="profile.zip" placeholder="ZIP Code" />

			<span class="gigya-error-msg" data-bound-to="profile.gender" ></span>
			<label class="gender-label">Gender:</label>
			<label class="inline-label" for="profile-complete-gender-male"><input type="radio" id="profile-complete-gender-male" name="profile.gender" value="m" />Male</label>
			<label class="inline-label" for="profile-complete-gender-female"><input type="radio" id="profile-complete-gender-female" name="profile.gender" value="f" />Female</label>
			...
			<label for="listening-frequency">On a typical day, about how much time would you say that you spend listening to the radio?</label>
			<span class="gigya-error-msg" data-bound-to="data.listeningFrequency" ></span>
			<select name="data.listeningFrequency" id="listening-frequency">
				<option disabled selected value>Select One</option>
			...
			<label for="listening-loyalty">When you're listening to the radio, about what percentage of time do you spend listening to 102.9 WMGK?</label>
			<span class="gigya-error-msg" data-bound-to="data.listeningLoyalty" ></span>
			<select name="data.listeningLoyalty" id="listening-loyalty">
				<option disabled selected value>Select One</option>
	...
	<div class="gigya-screen" id="gigya-update-profile-screen" data-responsive="true">
		...
		<form class="gigya-profile-form" id="gigya-profile-form" data-on-success-screen="gigya-update-profile-success-screen">
			...
			<input type="text" name="profile.email" id="verify-email" />

			<span class="gigya-error-msg" data-bound-to="profile.firstName" ></span>
			<label id="profile-firstName">First Name:</label>
			<input type="text" name="profile.firstName" id="profile-firstName" />

			<span class="gigya-error-msg" data-bound-to="profile.lastName" ></span>
			<label for="profile-lastName">Last Name:</label>
			<input type="text" name="profile.lastName" id="profile-lastName" />

			<span class="gigya-error-msg" data-bound-to="profile.birthYear" ></span>
			<label for="profile-birthYear">Year of Birth:</label>
			<select name="profile.birthYear" id="profile-birthYear">
				<?php foreach ( range( 1920, date( 'Y' ) ) as $year ) { ?>
					<option value="<?php echo esc_attr( $year ); ?>"><?php echo esc_html( $year ); ?></option>
				<?php } ?>
			</select>
			...
			<span class="gigya-error-msg" data-bound-to="profile.birthMonth" ></span>
			<label id="profile-birthMonth">Month of Birth:</label>
			<select name="profile.birthMonth" id="profile-birthMonth">
				<?php foreach ( $months as $month_num => $month_name ) { ?>
					<option value="<?php echo esc_attr( $month_num + 1 ); ?>">
						<?php echo esc_html( $month_name ); ?>
					</option>
			...
			<span class="gigya-error-msg" data-bound-to="profile.birthDay" ></span>
			<label for="profile-birthDay">Day of Birth:</label>
			<select name="profile.birthDay" id="profile-birthDay">
				<?php foreach ( range( 1, 31 ) as $day_num ) { ?>
					<option value="<?php echo esc_attr( $day_num ); ?>">
						<?php echo esc_html( $day_num ); ?>
					</option>
			...
			<span class="gigya-error-msg" data-bound-to="profile.zip" ></span>
			<label id="profile-zip">ZIP Code:</label>
			<input type="text" name="profile.zip" id="profile-zip" />

			<span class="gigya-error-msg" data-bound-to="profile.gender" ></span>
			<label class="gender-label">Gender:</label>
			<label class="inline-label" for="profile-gender-male"><input type="radio" name="profile.gender" id="profile-gender-male" value="m" />Male</label>
			<label class="inline-label" for="profile-gender-female"><input type="radio" name="profile.gender" id="profile-gender-female" value="f" />Female</label>
	...
	<div class="gigya-screen" id="gigya-change-password-screen" data-responsive="true">
		...
		<form class="gigya-profile-form" id="gigya-profile-form" data-on-success-screen="gigya-change-password-success-screen">
			...
			<span class="gigya-error-msg" data-bound-to="password" ></span>
			<label for="pChange-old-password">Enter your current password:</label>
			<input type="password" name="password" id="pChange-old-password" />

			<span class="gigya-error-msg" data-bound-to="newPassword" ></span>
			<label for="pChange-new-password">Choose a new password:</label>
			<input type="password" name="newPassword" id="pChange-new-password" />

			<span class="gigya-error-msg" data-bound-to="passwordRetype" ></span>
			<label for="pChange-new-password-retype">Retype new password:</label>
			<input type="password" name="passwordRetype" id="pChange-new-password-retype" />
	...
	<div class="gigya-screen" id="gigya-reset-link-password-screen" data-responsive="true">
		...
		<form class="gigya-profile-form" id="gigya-reset-link-password-form">
			...
			<span class="gigya-error-msg" data-bound-to="newPassword" ></span>
			<label for="pReset-new-password">Choose a new password:</label>
			<input type="password" name="newPassword" id="pReset-new-password" />

			<span class="gigya-error-msg" data-bound-to="passwordRetype" ></span>
			<label for="pReset-new-password-retype">Confirm new password:</label>
			<input type="password" name="passwordRetype" id="pReset-new-password-retype" />
